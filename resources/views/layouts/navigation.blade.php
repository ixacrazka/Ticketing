...
<nav x-data="{ open: false }" class="p-6 text-gray-800 mt-4">
    <div class="bg-neon rounded-xl py-5 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Hamburger  Moblile Version-->
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-gray-900 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 focus:text-gray-900 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('jenis.index')" :active="request()->routeIs('jenis')">
                {{ __('Jenis Pengaduan') }}
            </x-responsive-nav-link>
